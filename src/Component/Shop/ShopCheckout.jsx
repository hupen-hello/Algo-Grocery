      ...
      <div className="col-lg-5">
              ...
              <tbody>
                <tr>
                  <td className="image product-thumbnail">
                    <img src="https://nest-frontend.netlify.app/assets/imgs/shop/product-1-1.jpg" alt="#" />
                  </td>
                  <td>
                    <h6 className="w-160 mb-5">
                      <a className="text-heading" href="shop-product-full.html">
        ...
        <div className="payment ml-30">
          ...
          <div className="payment-logo d-flex">
            <img
              className="mr-15"
              src="https://nest-frontend.netlify.app/assets/imgs/theme/icons/payment-paypal.svg"
              alt=""
            />
            <img
              className="mr-15"
