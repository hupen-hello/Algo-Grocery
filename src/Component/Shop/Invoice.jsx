...
function Invoice() {
  return (
    <>
    <div className="invoice invoice-content invoice-3">
  <div className="back-top-home hover-up mt-30 ml-30">
    <a className="hover-up" href="index.htm">
          ...
          <div className="invoice-info" id="invoice_wrapper">
                ...
                <div className="col-sm-6">
                  <div className="invoice-name">
                    <div className="logo">
                      <a href="index.htm">
                        <img
                          src="https://nest-frontend.netlify.app/assets/imgs/theme/logo-light.svg"
                          alt="logo"
                        />
                      </a>
                    </div>
                ...
                <div className="col-sm-6  text-end">
                  <div className="invoice-numb">
                    <h4 className="invoice-header-1 mb-10 mt-20">
                      Invoice No: <span className="text-heading">#1970191</span>
                    </h4>
                    <h6>
                      Invoice Date:{" "}
                      <span className="text-heading">30 Nov 2022</span>
                    </h6>
                  </div>
                </div>
              </div>
            ...
            <div className="invoice-top">
              <div className="row">
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="invoice-number">
                    <h4 className="invoice-title-1 mb-10">Overview</h4>
                    <p className="invoice-addr-1">
                      <strong>Invoice Data:</strong> Aug 27, 2022 <br />
                      <strong>Due Data:</strong> Aug 27, 2022
                      <br />
                      <strong>Payment Method:</strong> Payoneer
                      <br />
