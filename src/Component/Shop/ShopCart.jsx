...
import { faHome ,faRefresh , faTag  } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className="d-flex justify-content-between">
          ...
          <h6 className="text-body">
            <a href="#" className="text-muted">
              <FontAwesomeIcon icon={faTrash} className="fi-rs-trash" />
              Clear Cart
            </a>
          </h6>
        </div>
    ...
    <div className="row">
      <div className="col-lg-8">
            ...
            <tbody>
              <tr className="pt-30">
                ...
                <td className="image product-thumbnail pt-40">
                  <img src="https://nest-frontend.netlify.app/assets/imgs/shop/product-3-1.jpg" alt="#" />
                </td>
        ...
        <div className="cart-action d-flex justify-content-between">
          ...
          <FontAwesomeIcon icon={faRefresh} className="mr-10" />
            Update Cart
          </a>
        </div>
            ...
            <div className="p-40">
              ...
              <form action="#">
                <div className="d-flex justify-content-between">
                  ...
                  <FontAwesomeIcon icon={faTag} className="mr-10" />
                    Apply
                  </button>
                </div>
              </form>
      ...
      <div className="col-lg-4">
        <div className="border p-md-4 cart-totals ml-30">
          ...
          <a href="#" className="btn mb-20 w-100">
            Proceed To CheckOut
            <FontAwesomeIcon icon={faSignOutAlt} className="ml-15" />
          </a>
        </div>
      </div>
    </div>
