                                                ...
                                                <div className="detail-gallery">
                                                    ...
                                                    <Slider {...settings}>
                                                        <figure className="border-radius-10">
                                                            <img
                                                                src="https://nest-frontend.netlify.app/assets/imgs/shop/product-16-6.jpg"
                                                                alt="product image"
                                                            />
                                                        </figure>
                                                        <figure className="border-radius-10">
                                                                ...
                                                                <div className="product-img product-img-zoom">
                                                                    <a href="shop-product-right.html" tabIndex={0}>
                                                                        <img
                                                                            ...
                                                                            src="https://nest-frontend.netlify.app/assets/imgs/shop/product-2-1.jpg"
                                                                            alt=""
                                                                        />
                                                                        <img
                                                                            className="hover-img"
                                                                            src="https://nest-frontend.netlify.app/assets/imgs/shop/product-2-2.jpg"
                                                                            alt=""
                                                                        />
                                                                    </a>
                                                                </div>
