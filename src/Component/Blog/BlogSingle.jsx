...
function BlogSingle() {
  ...
  <div className="page-header breadcrumb-wrap">
    <div className="container">
      <div className="breadcrumb">
        ...
        <span /> <a href="shop-grid-right.html">Recipes</a> <span /> Best
        smartwatch 2022: the top wearables you can buy today
      </div>
    </div>
  </div>
            ...
            <div className="col-lg-9">
              <div className="single-page pt-50 pl-30">
                <div className="single-header style-2">
                  <div className="row">
                    <div className="col-xl-10 col-lg-12 m-auto">
                      ...
                      <h2 className="mb-10">
                        Best smartwatch 2022: the top wearables you can buy
                        today
                      </h2>
                        ...
                        <div className="entry-meta meta-1 font-xs mt-15 mb-15">
                          <a className="author-avatar" href="#">
                            <img
                              ...
                              src="https://nest-frontend.netlify.app/assets/imgs/blog/author-1.png"
                              alt=""
                            />
                          </a>
                          <span className="post-by">
                            By <a href="#">Sugar Rosie</a>
                          </span>
                        ...
                        <div className="social-icons single-share">
                          <ul className="text-grey-5 d-inline-block">
                            <li className="mr-5">
                              <a href="#">
                                <img
                                  src="https://nest-frontend.netlify.app/assets/imgs/theme/icons/icon-bookmark.svg"
                                  alt=""
                                />
                              </a>
                            </li>
                            <li>
                              <a href="#">
                                <img
                                  src="https://nest-frontend.netlify.app/assets/imgs/theme/icons/icon-heart-2.svg"
                                  alt=""
                                />
                              </a>
                            </li>
                ...
                <figure className="single-thumbnail">
                  <img src="https://nest-frontend.netlify.app/assets/imgs/blog/blog-19.png" alt="" />
                </figure>
                <div className="single-content">
                  <div className="row">
                    <div className="col-xl-10 col-lg-12 m-auto">
                      <p className="single-excerpt">
                        Helping everyone live happier, healthier lives at home
                        through their kitchen. Kitchn is a daily food magazine
                        on the Web celebrating life in the kitchen through home
                      ...
                      <img
                        className="mb-30"
                        src="https://nest-frontend.netlify.app/assets/imgs/blog/blog-21.png"
                        alt=""
                      />
                      <p>
                        ...
                        turpis nunc in turpis massa et eget facilisis ante
                        molestie penatibus dolor volutpat, porta pellentesque
                        scelerisque at ornare dui tincidunt cras feugiat tempor
                        lectus
                      </p>
                      <blockquote>
                        <p>
                          ...
                          . Ut venenatis tincidunt diam elementum imperdiet.
                          Etiam accumsan semper nisl eu congue. Sed aliquam
                          magna erat, ac eleifend lacus rhoncus in.
                        </p>
                      </blockquote>
                      <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Amet id enim, libero sit. Est donec lobortis cursus
                        amet, cras elementum libero convallis feugiat. Nulla
                        faucibus facilisi tincidunt a arcu, sem donec sed sed.
                        Tincidunt morbi scelerisque lectus non. At leo mauris,
                        vel augue. Facilisi diam consequat amet, commodo lorem
                        nisl, odio malesuada cras. Tempus lectus sed libero
                        ...
                        <div className="social-icons single-share">
                          <ul className="text-grey-5 d-inline-block">
                            ...
                            <li className="social-facebook">
                              <a href="#">
                                <img
                                  src="https://nest-frontend.netlify.app/assets/imgs/theme/icons/icon-twitter.svg"
                                  alt=""
                                />
                              </a>
                            </li>
                      ...
                      <div className="author-bio p-30 mt-50 border-radius-15 bg-white">
                        ...
                        <div className="author-des">
                          <p>
                            Hi there, I am a veteran food blogger sharing my
                            daily all kinds of healthy and fresh recipes. I find
                            inspiration in nature, on the streets and almost
                            everywhere. Lorem ipsum dolor sit amet, consectetur
                            adipiscing elit. Amet id enim, libero sit. Est donec
                            lobortis cursus amet, cras elementum libero
                          </p>
                        </div>
                      </div>
                      {/*Comment form*/}
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="shop-grid-right.html">
                        {" "}
                        <img
 src="https://nest-frontend.netlify.app/assets/imgs/theme/icons/category-1.svg"                          alt=""
                        />
                        Pet Foods{" "}
                      </a>
 ...
 src="https://nest-frontend.netlify.app/assets/imgs/theme/icons/category-1.svg"                          alt=""
                ...
                <div className="sidebar-widget product-sidebar mb-50 p-30 bg-grey border-radius-10">
                  ...
                  <div className="single-post clearfix">
                    <div className="image">
                    <img src="https://nest-frontend.netlify.app/assets/imgs/shop/thumbnail-3.jpg" alt="#" />                    </div>
                    <div className="content pt-10">
                      <h6>
                      ...
                      <li>
                        <a href="#">
                          <img
                            ...
                            src="https://nest-frontend.netlify.app/assets/imgs/shop/thumbnail-1.jpg"
                            alt=""
                          />
                        </a>
                      </li>
