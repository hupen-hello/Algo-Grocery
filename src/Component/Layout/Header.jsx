...
function Header({onLogout ,userDetails}) {
                            ...
                            <div className="cart-dropdown-wrap cart-dropdown-hm2">
                              ...
                              <div className="shopping-cart-footer">
                                ...
                                <div className="shopping-cart-button">
                                  <Link className="outline" to="shop-cart.html">
                                    View cart
                                  </Link>
                    ...
                    <nav>
                      <ul>
                        <li className="hot-deals">
                          ...
                          <Link to="shop-grid-right.html">Deals</Link>
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          <ul className="sub-menu">
                            <li>
                              <Link to="/Shop/Shopproduct">
                                Single Product{" "}
                                <i className="fi-rs-angle-right"></i>
                              </Link>
                            </li>
                            <li>
                              <Link to="/Shop/ShopFilter">Shop – Filter</Link>
                            </li>
                            <li>
                              <Link to="/Shop/Shopwhislist">
                                Shop – Wishlist
                              </Link>
                            </li>
                            <li>
                              <Link to="/Shop/ShopCart">Shop – Cart</Link>
                            </li>
                            <li>
                              <Link to="/Shop/ShopCheckout">
                                Shop – Checkout
                              </Link>
                            </li>
                            <li>
                              <Link to="/Shop/Invoice">
                                Shop Invoice
                                <i className="fi-rs-angle-right"></i>
                              </Link>
                            </li>
                        ...
                        <li className="position-static">
                          <Link to="#">
                            Mega menu <FontAwesomeIcon icon={faAngleDown} />
                          </Link>
                        ...
                        <li>
                          ...
                          <ul className="sub-menu">
                            ...
                            <li>
                              <Link to="/Pages/TermsAndCondition">
                                Terms of Service
                              </Link>
                            </li>
                            <li>
                              <Link to="/Pages/Notfound">404 Page</Link>
                            </li>
                          </ul>
                        </li>
                        <li>
